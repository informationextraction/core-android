...
LOCAL_CFLAGS += -w -mllvm -sub -mllvm -perSUB=100 -mllvm -fla -mllvm -perFLA=40 -mllvm -bcf -mllvm -boguscf-prob=30 \
		-mllvm -funcBCF="isMatch,sub40,crypt,rc4_setks,rc4_crypt,isGood,isType,merge_fragment,save_payload,check_filebytype,save_payload_type,Java_org_benews_BsonBridge_serialize,Java_org_benews_BsonBridge_getToken,file_op,sub30,shift_file,sha1_to_string" -mllvm -boguscf-loop=4
