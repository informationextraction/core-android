#
# This DexGuard configuration file illustrates how to use annotations for
# specifying which classes and class members should be kept.
# Usage:
#     java -jar dexguard.jar @examples.pro
#
...
# We have to specify what the annotations mean to DexGuard.
