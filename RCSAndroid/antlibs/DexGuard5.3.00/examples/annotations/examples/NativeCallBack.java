...
/**
 * This application illustrates the use of annotations for configuring DexGuard.
 *
 * You can compile it with:
 *     javac -classpath ../lib/annotations.jar NativeCallBack.java
 * You can then process it with:
 *     java -jar ../../../lib/dexguard.jar @ ../examples.pro
 *
...
public class NativeCallBack
{
     ...
     *
     * The -keep option regular DexGuard configuration will make sure it is
     ...
     *
     * DexGuard would remove it, because it is not referenced from java.
